...
""" This file imports all needed functions from milestones and runs in the main function Simulate.
    ...
    To Run:
    In your /code directory, run python3 run_newTask.py
...
if __name__ == "__main__":
    ...
    Ki = np.eye(6) * 0.2
    print('newTask')
    Simulate(config_i, Tse_i, Tsc_i, Tsc_f, Kp, Ki, dt, v_lim, log_file='newTask.log', Traj_file='newTask_traj.csv', Xerr_file='newTask_Xerr.csv', img ='newTask.png')